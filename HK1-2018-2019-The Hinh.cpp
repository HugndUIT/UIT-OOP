...
public:
    ...
    void DisplayInfo() const override {
        cout << setw(15) << left << ServicePack << " | Phi Co Ban: " << setw(5) << BasicFee << " | Chi Phi Lop Hoc: 0 | Dich Vu Xong Hoi: 0 | Ho Tro PT: " << PTsupport << endl;
    }
};
...
public:
    ...
    void DisplayInfo() const override {
        cout << setw(15) << left << ServicePack << " | Phi Co Ban: " << setw(5) << BasicFee << " | Chi Phi Lop Hoc: " << setw(5) << ClassFee << " | Ho Tro PT: " << PTsupport << endl;
    }
};
...
public:
    ...
    void DisplayInfo() const override {
        cout << setw(15) << left << ServicePack << " | Phi Co Ban: " << setw(5) << BasicFee << " | Ho Tro PT: " << PTsupport << endl;
    }
};
...
public:
    ...
    void DisplayInfo() const {
        cout << setw(20) << left << Hoten << " | CMND: " << setw(12) << CMND << " | ";
        DichVu->DisplayInfo();
    }
    ~Customer() {
        delete DichVu;
